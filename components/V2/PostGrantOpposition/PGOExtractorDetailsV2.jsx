...
const PGOExtractorDetailsV2 = ({ formData, updateFormData, page }) => {
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-purple-100 text-sm mt-1">Patent extraction and analysis details</p>
          </div>
        </div>
      </div>
...
export default PGOExtractorDetailsV2;
