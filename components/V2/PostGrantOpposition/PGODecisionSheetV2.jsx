...
const PGODecisionSheetV2 = ({ formData, updateFormData, page }) => {
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-purple-100 text-sm mt-1">Decision making and documentation</p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-2">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-xl p-4 hover:border-purple-400 transition-colors">
              <input
                ...
                className="hidden"
                id="decision-attachments-upload"
              />
              <label
                htmlFor="decision-attachments-upload"
...
export default PGODecisionSheetV2;
