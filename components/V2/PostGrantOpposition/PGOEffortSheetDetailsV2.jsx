...
const PGOEffortSheetDetailsV2 = ({ formData, updateFormData, page }) => {
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-purple-100 text-sm mt-1">Efforts and costs for opposition</p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <label className="flex items-center space-x-2 text-sm font-medium text-gray-700">
                ...
                <span>Efforts Spent for opposition of Invention</span>
              </label>
              <input
                type="text"
            ...
            <div className="space-y-2">
              <label className="flex items-center space-x-2 text-sm font-medium text-gray-700">
                ...
                <span>Number of Hours Spent</span>
              </label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <label className="flex items-center space-x-2 text-sm font-medium text-gray-700">
                ...
                <span>External Agency opposer</span>
              </label>
              <input
                type="text"
            ...
            <div className="space-y-2">
              <label className="flex items-center space-x-2 text-sm font-medium text-gray-700">
                ...
                <span>Cost Spent on Agency</span>
              </label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
            <div className="space-y-2">
              <label className="flex items-center space-x-2 text-sm font-medium text-gray-700">
                <User className="h-4 w-4 text-purple-600" />
                <span>Manager Responsible (Emp ID)</span>
              </label>
              <input
                type="text"
...
export default PGOEffortSheetDetailsV2;