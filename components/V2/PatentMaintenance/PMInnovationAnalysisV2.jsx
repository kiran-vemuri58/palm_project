...
const PMInnovationAnalysisV2 = ({ formData, updateFormData, page }) => {
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-blue-100 text-sm mt-1">Analysis of invention and prior art</p>
          </div>
        </div>
      </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-4 hover:border-blue-400 transition-colors">
                    <input
                      ...
                      className="hidden"
                      id="pm-prior-art-upload"
                    />
                    <label
                      htmlFor="pm-prior-art-upload"
...
export default PMInnovationAnalysisV2;
