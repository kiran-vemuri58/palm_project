...
function getInitialFormData(page) {
  const initialData = {
    ...
    patentProsecution: {
      ...
      pppd_date_pregrant_opposition: '',
      pppd_date_reply_pregrant_opposition: '',
      pppd_opponent_name: '',
      pppd_attachments: [],
    ...
    postGrantOpposition: {
      ...
      publicationNumber: '',
      apopposed: '',
      datePostGrantOpposition: '',
      dateResponsePostGrantOpposition: '',
      dateHearingOpposition: '',
      oname: '',
      opposerAttachment: [],
      cfbopposer: '',
      boaof: '',
    ...
    switch (page) {
      ...
      case 'postGrantOpposition':
        return {
          ...
          datePostGrantOpposition: apiData.datePostGrantOpposition || '',
          dateResponsePostGrantOpposition: apiData.dateResponsePostGrantOpposition || '',
          dateHearingOpposition: apiData.dateHearingOpposition || '',
          oname: apiData.oname || '',
      ...
      case 'patentProsecution':
        const ppResult = {
          ...
          pppd_date_pregrant_opposition: apiData.pppd_date_pregrant_opposition || '',
          pppd_date_reply_pregrant_opposition: apiData.pppd_date_reply_pregrant_opposition || '',
